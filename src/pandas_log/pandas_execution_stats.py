"""
pandas_log.pandas_execution_stats
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

.. note::

   The ``pandas_log.pandas_execution_stats`` module is copied directly from
...
class StepStats:
    def __init__(
        ...
        """ Constructor
            :param execution_stats: execution_stats of the pandas operation both in
                                    time and memory
    ...
    def log_stats_if_needed(self, silent, verbose, copy_ok):
        ...
        if (
            ...
            if s:
                # If this method isn't patched and verbose is False, __repr__ will
                # give an empty string, which we don't want to print
                print(s)
